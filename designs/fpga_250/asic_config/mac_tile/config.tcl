...
set nate_lef $nate_src/transmission_gate.lef
set nate_gds $nate_src/transmission_gate.gds
...
set ::env(EXTRA_LEFS) [list $mac_lef $nate_lef]
set ::env(EXTRA_GDS_FILES) [list $mac_gds $nate_gds]
